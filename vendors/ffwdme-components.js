 ...
 * @version v0.4.0
 * @copyright Copyright (c) 2011-2014 Christian BÃ¤uerlein, Silvia Hundegger; 2012-2014 flinc. All rights reserved.
 */
(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    var AudioInstructions = Base.extend({
        ...
        navigationOnRoute: function(e) {
            ...
            var action = this.audioAction(distance, nextDirection.turn_type);
        ...
        audioAction: function(distance, turn_type) {
            ...
            if (/^EXIT/.test(turn_type) && distance > 500){
                return '';
            }

            if (/^EXIT/.test(turn_type)){
                return turn_type;
            }
            ...
            if (distance > (1000-acceptedBackwardsMeters) && distance < (1000+this.forwardMeters)) {
                ...
                _distance = '_100';
            } else if (distance > 0 && distance < (10 + this.forwardMeters) && turn_type != 'C') {
                _distance = '_now';
            }
            if (_distance.length){
                return turn_type + _distance;
            } else {
                return '';
            }
        },
